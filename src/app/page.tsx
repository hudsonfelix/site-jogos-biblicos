        ...
        <div className="container mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8">
                ...
                <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-sm border-4 border-primary relative transform lg:scale-110">
                    ...
                    <p className="text-5xl font-bold mb-6">R$29<span className="text-lg font-normal">,90</span></p>
    ...
    <section className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                    <div className="flex items-center mb-4">
                        <Image src="https://placehold.co/50x50/EBF8FF/3182CE?text=M" alt="Avatar Marcos P." width={50} height={50} className="rounded-full mr-4"/>
                        <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                    <div className="flex items-center mb-4">
                        <Image src="https://placehold.co/50x50/EBF8FF/3182CE?text=C" alt="Avatar Carla F." width={50} height={50} className="rounded-full mr-4"/>
                        <div>
